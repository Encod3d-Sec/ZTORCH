...
- Model routing (see `## Model routing`): the GLM flagship drives; GLM-Flash for bounded short tasks; the mandatory
  main-tier **verifier** gates every finding via `verdicts/<F>.json`. No open-ended hunter fan-out.
