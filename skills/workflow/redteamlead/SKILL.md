...
Dispatch ONE subagent via the Agent tool on a mid/high tier (GLM; pin `model` only if your ZCode build
exposes per-agent selection) (a fresh, independent context; it is NOT
