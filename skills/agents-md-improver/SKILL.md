...
description: Offline instruction-file reviewer for AGENTS.md (ZCode's project context file). Audit and improve AGENTS.md files - scan for AGENTS.md files, evaluate quality against templates, output a report, then make targeted updates. Invoke explicitly (/agents-md-improver) when the plugin is unavailable.
...
Audit, evaluate, and improve AGENTS.md files across a codebase to ensure ZCode has optimal project context.
...
| Global defaults | `~/.zcode/AGENTS.md` | User-wide defaults across all projects |
| Package-specific | `./packages/*/AGENTS.md` | Module-level context in monorepos |
| Subdirectory | Any nested location | Feature/domain-specific context |

**Note:** ZCode resolves AGENTS.md from the working directory upward to the project root; use one AGENTS.md per repository/package root.
...
- **`#` key shortcut**: ZCode has no `#` memory shortcut; append learnings by editing AGENTS.md directly
...
- **Global defaults**: Put user-wide preferences in `~/.zcode/AGENTS.md`
