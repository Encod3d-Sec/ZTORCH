...
def test_expected_hooks_trimmed():
    ...
    assert len(ch.EXPECTED_HOOKS) == 12            # -web-recon; +drift-guard; -pre-compact; +sleep-guard (2026-08-30 blind-wait enforcement)
...
def test_wiki_log_removed_and_count_is_12():
    ...
    assert len(ch.EXPECTED_HOOKS) == 12   # ... -web-recon, +drift-guard, -pre-compact, +sleep-guard (2026-08-30)
