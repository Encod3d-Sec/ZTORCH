...
`AGENTS.md` carries the compact top-level tree; this is the detailed per-file reference.

```
ZTORCH/
├── AGENTS.md                    <- agent instructions (+ README.md, LICENSE)
├── .zcode/config.json           <- ZCode hook registration (committed)
